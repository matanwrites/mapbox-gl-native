...
final class MapGestureDetector {
  ...
  private class GestureListener extends android.view.GestureDetector.SimpleOnGestureListener {
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
      Timber.e("OnFling invoke!!!! %s", quickZoom);
  ...
  private class ScaleGestureListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
    ...
    public boolean onScale(ScaleGestureDetector detector) {
      ...
      if (focalPoint != null) {
        ...
        Timber.e("ZoomBy is %s", negative ? -zoomBy : zoomBy);
    ...
    public void onScaleEnd(final ScaleGestureDetector detector) {
      Timber.e("onScaleEnd %s", quickZoom);
  ...
  private class RotateGestureListener extends RotateGestureDetector.SimpleOnRotateGestureListener {
    ...
    private static final float ROTATE_INVOKE_ANGLE = 14.5f;
    private static final float ROTATE_LIMITATION_ANGLE = 3.15f;
